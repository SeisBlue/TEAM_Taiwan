...
end_year = 2008
event = pd.read_csv(
    f"../../events_traces_catalog/{start_year}_{end_year}_ok_events.csv"
)
...
for eq_id in event["EQ_ID"]:
    ...
    tmp_trace_sta_lon_lat = tmp_trace_sta_lon_lat[
        (tmp_trace_sta_lon_lat["station_name"] != drop_station_name)
    ].reset_index()
