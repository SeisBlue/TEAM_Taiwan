...
with h5py.File(data_path, "r") as origin, h5py.File(
    "../data/2016_sample.hdf5", "w"
) as sample:
...
init_event_metadata.to_hdf(
    "2016_sample.hdf5", key="metadata/event_metadata", mode="a", format="table"
)
trace_metadata.to_hdf(
    "2016_sample.hdf5", key="metadata/traces_metadata", mode="a", format="table"
)
