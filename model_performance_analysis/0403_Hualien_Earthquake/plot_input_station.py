...
sys.path.append("..")
from model_performance_analysis.analysis import TriggeredMap
...
fig, ax_map = TriggeredMap.plot_station_map(
    trace_info=station_info, min_epdis=10.87177078, sec=mask_after_sec
)
